...
class Tabs(QWidget):
    ...
    def btn_statistics(self):
        ...
        if sender.text() == 'Statistics':
            ...
            self.table2.setHorizontalHeaderLabels(['TP', 'FP', 'TN', 'FN', 'Precision_T', 'Recall_T', 'F1_T', 'Precision_F', 'Recall_F', 'F1_F'])
            ...
            self.table2.setItem(num_rows, 4, QTableWidgetItem(str(precision_t)))
            self.table2.setItem(num_rows, 5, QTableWidgetItem(str(recall_t)))
            self.table2.setItem(num_rows, 6, QTableWidgetItem(str(f1)))
            self.table2.setItem(num_rows, 7, QTableWidgetItem(str(precision_f)))
            self.table2.setItem(num_rows, 8, QTableWidgetItem(str(recall_f)))
            self.table2.setItem(num_rows, 9, QTableWidgetItem(str(f1_f)))
